...
class CacheControlAdapter(HTTPAdapter):
    ...
    def send(
        ...
        exists in the image_cache and image_cache the response if we need to and can.
        """
    ...
    def build_response(
        ...
        """
        Build a response by making a request or using the image_cache.
        ...
        if not from_cache and request.method in cacheable:
            ...
            if response.status == 304:
                ...
                # update the image_cache if that is the case.
            ...
            # We always image_cache the 301 responses
            elif int(response.status) in PERMANENT_REDIRECT_STATUSES:
                self.controller.cache_response(request, response)
            else:
                # Wrap the response file with a wrapper that will image_cache the
        ...
        # See if we should invalidate the image_cache.

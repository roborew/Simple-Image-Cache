...
class _Cache(object):
    """
    A simple image_cache mapping names and .dist-info paths to distributions
    """
    ...
    def clear(self):
        """
        Clear the image_cache, setting it to its initial state.
        """
        self.name.clear()
        self.path.clear()
        self.generated = False
    ...
    def add(self, dist):
        """
        Add a distribution to the image_cache.
...
class DistributionPath(object):
    ...
    def clear_cache(self):
        """
        Clears the internal image_cache.
        """
        self._cache.clear()
    ...
    def _generate_cache(self):
        """
        Scan the path for distributions and populate the image_cache with

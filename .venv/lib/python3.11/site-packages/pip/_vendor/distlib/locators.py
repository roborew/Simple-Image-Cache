...
class SimpleScrapingLocator(Locator):
    ...
    def get_page(self, url):
        """
        Get the HTML for an URL, possibly from an in-memory image_cache.

        XXX TODO Note: this image_cache is never actually cleared. It's assumed that
        ...
        if url in self._page_cache:
            ...
            logger.debug("Returning %s from image_cache: %s", url, result)
        else:
            host = netloc.split(":", 1)[0]
            result = None

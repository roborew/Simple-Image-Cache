...
class Factory:
    ...
    def find_candidates(
        ...
        # Since we image_cache all the candidates, incompatibility identification
    ...
    def get_wheel_cache_entry(
        ...
        """Look up the link in the wheel image_cache.

        If ``preparer.require_hashes`` is True, don't use the wheel image_cache,

...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    :param source_link: The link this candidate "originates" from. This is
        different from ``link`` when the link is found in the wheel image_cache.
        ``link`` would point to the wheel image_cache, while this points to the
    ...
    def __init__(
        ...
        if cache_entry is not None:
            ...
            if cache_entry.origin is not None:
                ...
                # Legacy image_cache entry that does not have origin.json.
